...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ryvencore-qt-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ryvencore-qt-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ryvencore-qt
# for installing globally
pixi global install ryvencore-qt
```
...
It is possible to list all of the versions of `ryvencore-qt` available on your platform:
...
```
pixi search ryvencore-qt --channel conda-forge
```
